...
def handle_data(context):
    ...
    # 如果突破10日均线买入0.2BTC
    if (current_price_1 > 1.1*MA10_1):
       order_id=context.account_1.buy("BTC/USDT.binance", current_price_1, 0.2)
    
        # log.info("价格突破10日均线, 买入BTC, 价格：%d" % (current_price_1))
    # 如果跌破10日均线卖出0.2BTC
    elif (current_price_1 < 0.9*MA10_1):
