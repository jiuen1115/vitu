...
def handle_data(context):
    ...
    current_price_1 = context.get_price("BTC/USDT.poloniex")
    # depth1=context.get_depth("BTC/USDT.binance")
    # ask1=depth1['asks'][0]
    # 如果突破10日均线买入0.2BTC
    if (current_price_1 > MA10_1):
        context.account_1.buy("BTC/USDT.poloniex", current_price_1, 0.2)
        # log.info("价格突破10日均线, 买入BTC, 价格：%d" % (current_price_1))
    # 如果跌破10日均线卖出0.2BTC
    elif (current_price_1 < MA10_1):
        context.account_1.sell("BTC/USDT.poloniex", current_price_1, 0.2)
